...
describe('Base Registry', () => {
	...
	describe('Initialization', () => {
		...
		test('should have empty type names by kind initially', () => {
	...
	describe('Type Registration', () => {
		...
		test('should mark generated types correctly', () => {
		...
		test('should update existing type when re-registered', () => {
	...
	describe('Type Retrieval', () => {
		...
		test('should check type existence', () => {
			expect(registry.hasType('User')).toBe(true)
			expect(registry.hasType('NonExistent')).toBe(false)
		})

		test('should get type info', () => {
		...
		test('should get type names by kind', () => {
		...
		test('should return empty array for kinds with no types', () => {
	...
	describe('Type Kind Checking', () => {
		...
		test('should check if type is of specific kind', () => {
		...
		test('should return false for non-existent types', () => {
	...
	describe('Generated Types Filtering', () => {
		...
		test('should get only generated types', () => {
		...
		test('should get generated type names by kind', () => {
			const generatedTypes = registry.getGeneratedTypes()
		...
		test('should return empty array for kinds with no generated types', () => {
			const generatedTypes = registry.getGeneratedTypes()
	...
	describe('Registry Statistics', () => {
		test('should provide accurate count of all types', () => {
			expect(registry.getAllTypes()).toHaveLength(0)
		...
		test('should provide accurate count by kind', () => {
			registry.registerType('User', TypeKind.OBJECT, 'user-data')
			registry.registerType('Post', TypeKind.OBJECT, 'post-data')
			registry.registerType('UserRole', TypeKind.ENUM, 'role-data')
	...
	describe('Type Registration Overrides', () => {
		test('should allow changing type kind when re-registering', () => {
		...
		test('should allow changing generated flag when re-registering', () => {
