...
describe('TypeScript Registry', () => {
	...
	describe('Initialization', () => {
		...
		it('should initialize with default imports in generated code', () => {
	...
	describe('Type Registration', () => {
		it('should register TypeScript types with string data', () => {
		...
		it('should handle generated flag correctly', () => {
	...
	describe('Type Registration with Dependencies', () => {
		it('should register type with dependencies', () => {
		...
		it('should not duplicate existing types in registerTypeWithDeps', () => {
		...
		it('should allow kind change in registerTypeWithDeps if different', () => {
	...
	describe('Code Generation', () => {
		it('should generate TypeScript code from registered types', () => {
		...
		it('should include default imports', () => {
			const generatedCode = registry.generateCode()
		...
		it('should only include generated types in code', () => {
			registry.registerType('GeneratedType', TypeKind.OBJECT, 'interface GeneratedType {}', true)
			registry.registerType('ManualType', TypeKind.OBJECT, 'interface ManualType {}', false)
	...
	describe('Dependency Management', () => {
		it('should add dependencies to existing types', () => {
			registry.registerType('User', TypeKind.OBJECT, 'interface User { name: string }')
		...
		it('should handle adding dependency to non-existent type', () => {
			expect(() => {
		...
		it('should handle circular dependencies in graph', () => {
	...
	describe('Schema Validation', () => {
		it('should return no warnings for valid dependencies', () => {
			registry.registerType('User', TypeKind.OBJECT, 'interface User { name: string }')
		...
		it('should return warnings for missing dependencies', () => {
		...
		it('should handle multiple types with missing dependencies', () => {
			registry.registerTypeWithDeps('Post', TypeKind.OBJECT, 'interface Post {}', ['User'])
	...
	describe('Import Generation', () => {
		...
		it('should handle custom scalars in imports', () => {
		...
		it('should handle no custom scalars', () => {
			const imports = registry.generateImports()
	...
	describe('Integration with Base Registry', () => {
		...
		it('should support generated type filtering from base', () => {
			registry.registerType('GeneratedType', TypeKind.OBJECT, 'interface GeneratedType {}', true)
			registry.registerType('ManualType', TypeKind.OBJECT, 'interface ManualType {}', false)
	...
	describe('Edge Cases', () => {
		...
		it('should handle empty type code', () => {
		...
		it('should handle null type code', () => {
	...
	describe('Performance', () => {
		it('should handle large numbers of types efficiently', () => {
		...
		it('should generate large code efficiently', () => {
			for (let i = 0; i < 100; i++) {
				registry.registerType(`Type${i}`, TypeKind.OBJECT, `interface Type${i} { id: string }`)
			}
		...
		it('should handle dependency operations efficiently', () => {
			for (let i = 0; i < 100; i++) {
